...
func (c *accountServiceClient) LoginAccount(ctx context.Context, in *LoginAccountRequest, opts ...grpc.CallOption) (*Account, error) {
	out := new(Account)
...
func (UnimplementedAccountServiceServer) LoginAccount(context.Context, *LoginAccountRequest) (*Account, error) {
